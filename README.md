...
>![Image of the folder layout for Structure Tutorial Mod which shows the structure nbt files are inside data.phenomena.structures which is inside src/main/resources](https://i.imgur.com/Q4FLSOT.png)
