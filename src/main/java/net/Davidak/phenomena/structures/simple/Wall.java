...
public class Wall extends Structure {
    ...
    public static final Codec<Wall> CODEC = RecordCodecBuilder.<Wall>mapCodec(instance ->
            instance.group(Wall.settingsCodec(instance),
    ...
    public Wall(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
       ...
       if (!Wall.extraSpawningChecks(context)) {
